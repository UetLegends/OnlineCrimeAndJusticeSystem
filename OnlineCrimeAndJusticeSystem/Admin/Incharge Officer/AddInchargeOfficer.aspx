<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AddInchargeOfficer.aspx.cs" Inherits="OnlineCrimeAndJusticeSystem.AddInchargeOfficer" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="card">
        <div class="card-header header-elements-inline">
            <h6 class="card-title">Add Incharge Officer</h6>
